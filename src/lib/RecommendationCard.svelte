...
<div>
	...
	{:then data}
			...
			<div in:fade class="relative flex flex-col md:flex-row bg-neutral-800/70 shadow-md p-6">
				...
				<div class="z-40 flex flex-col justify-between md:ml-6 pt-32 md:pt-0">
					...
					<div class="flex items-center">
						<div class="mr-4 py-1 px-2 rounded-full text-cyan-600 border border-cyan-600 text-xs">
							{data.Rated}
						</div>
					</div>
				</div>
		...
		{:else} -->
		<div in:fade class="relative flex flex-col bg-neutral-800/70 shadow-md p-6">
