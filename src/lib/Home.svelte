<div class="w-full">
	...
	>
		Get curated baby name <br class="hidden md:block" />recommendations
		<br class="hidden md:block" /> with Open AI
	</div>
	<div class="flex flex-wrap items-center mr-auto">
		<button
			on:click
			class="w-full md:w-auto text-center bg-cyan-600 hover:bg-cyan-700 mb-4 flex-none rounded-full text-white font-medium py-3 px-6 mr-8"
		>
			Get recommendations
		</button>
		<a
